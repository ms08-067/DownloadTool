/*!
FullCalendar Resources Common Plugin v6.0.0-beta.2
Docs & License: https://fullcalendar.io/premium
(c) 2022 Adam Shaw
*/
FullCalendar.Resource = (function (exports, internal$1, core, premiumCommonPlugin, preact) {
    'use strict';
    ...
    class ResourceLabelContainer extends internal$1.BaseComponent {
        ...
        render() {
            ...
            return (preact.createElement(internal$1.ViewContextType.Consumer, null, (context) => {
                ...
                return (preact.createElement(internal$1.ContentContainer, Object.assign({}, props, { elAttrs: Object.assign(Object.assign({}, props.elAttrs), { 'data-resource-id': props.resource.id, 'data-date': props.date ? internal$1.formatDayString(props.date) : undefined }), renderProps: renderProps, generatorName: "resourceLabelContent", generator: options.resourceLabelContent || renderInnerContent, classNameGenerator: options.resourceLabelClassNames, didMount: options.resourceLabelDidMount, willUnmount: options.resourceLabelWillUnmount })));
            }));
        }
    }
