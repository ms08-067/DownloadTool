...
class AlterDevelopToMaster127 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('queue_delay_seconds_manualul', function (Blueprint $table) {
        ...
        DB::table('queue_delay_seconds_manualul')->delete();
        DB::table('queue_delay_seconds_manualul')->insert($data);
