...
class SpreadsheetIndividualCell extends BaseComponent {
    ...
    render() {
        ...
        return (createElement(ContentContainer, { elTag: "td", elClasses: [
            ...
            }, renderProps: renderProps, generatorName: "cellContent", generator: colSpec.cellContent || renderResourceInner, classNameGenerator: colSpec.cellClassNames, didMount: colSpec.cellDidMount, willUnmount: colSpec.cellWillUnmount }, (InnerContent) => (createElement("div", { className: "fc-datagrid-cell-frame", style: { height: props.innerHeight } },
...
class SpreadsheetGroupCell extends BaseComponent {
    render() {
        ...
        return (createElement(ContentContainer, { elTag: "td", elClasses: [
            ...
            }, renderProps: renderProps, generatorName: "cellContent", generator: colSpec.cellContent || renderGroupInner, classNameGenerator: colSpec.cellClassNames, didMount: colSpec.cellDidMount, willUnmount: colSpec.cellWillUnmount }, (InnerContent) => (createElement("div", { className: "fc-datagrid-cell-frame fc-datagrid-cell-frame-liquid" },
    ...
    render() {
        ...
        return (createElement("tr", { role: "row" },
            createElement(ContentContainer, { elTag: "th", elClasses: [
                ...
                }, renderProps: renderProps, generatorName: "labelContent", generator: spec.labelContent || renderCellInner, classNameGenerator: spec.labelClassNames, didMount: spec.labelDidMount, willUnmount: spec.labelWillUnmount }, (InnerContent) => (createElement("div", { className: "fc-datagrid-cell-frame", style: { height: props.innerHeight } },
...
class SpreadsheetHeader extends BaseComponent {
    ...
    render() {
        ...
        rowNodes.push(createElement("tr", { key: "row", role: "row" }, colSpecs.map((colSpec, i) => {
            ...
            return (createElement(ContentContainer, { key: i, elTag: "th", elClasses: ['fc-datagrid-cell'], elAttrs: { role: 'columnheader' }, renderProps: renderProps, generatorName: "headerContent", generator: colSpec.headerContent, classNameGenerator: colSpec.headerClassNames, didMount: colSpec.headerDidMount, willUnmount: colSpec.headerWillUnmount }, (InnerContent) => (createElement("div", { className: "fc-datagrid-cell-frame", style: { height: rowInnerHeight } },
                createElement("div", { className: "fc-datagrid-cell-cushion fc-scrollgrid-sync-inner" },
    ...
    render() {
        ...
        return (createElement("tr", { ref: props.elRef },
            createElement(ContentContainer, { elTag: "td", elRef: props.elRef, elClasses: [
                    ...
                    'fc-resource-group',
                    context.theme.getClass('tableCellShaded'),
                ], renderProps: renderProps, generatorName: "laneContent", generator: renderHooks.laneContent, classNameGenerator: renderHooks.laneClassNames, didMount: renderHooks.laneDidMount, willUnmount: renderHooks.laneWillUnmount }, (InnerContainer) => (createElement(InnerContainer, { elTag: "div", elStyle: { height: props.innerHeight } })))));
    }
}
