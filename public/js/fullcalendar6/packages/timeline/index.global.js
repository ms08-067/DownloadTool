    ...
    class TimelineView extends internal$1.DateComponent {
        ...
        render() {
            ...
            return (preact.createElement(internal$1.ViewContainer, { elClasses: [
                ...
                preact.createElement(internal$2.ScrollGrid, { ref: this.scrollGridRef, liquid: !props.isHeightAuto && !props.forPrint, collapsibleWidth: false, colGroups: [
                        { cols: slatCols },
                    ], sections: sections })));
        }
...
})({}, FullCalendar.Internal, FullCalendar, FullCalendar.PremiumCommon, FullCalendar.Preact, FullCalendar.ScrollGrid.Internal);
