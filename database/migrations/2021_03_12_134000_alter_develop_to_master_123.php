...
class AlterDevelopToMaster123 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('bypass_manualdl_filecountcheck_force_notify_s3', function (Blueprint $table) {
        ...
        DB::table('bypass_manualdl_filecountcheck_force_notify_s3')->delete();
        DB::table('bypass_manualdl_filecountcheck_force_notify_s3')->insert($data);
