...
class AlterDevelopToMaster112 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('bypass_filecountcheck_force_notify', function (Blueprint $table) {
        ...
        DB::table('bypass_filecountcheck_force_notify')->delete();
        DB::table('bypass_filecountcheck_force_notify')->insert($data);
