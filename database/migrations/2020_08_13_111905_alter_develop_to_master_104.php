...
class AlterDevelopToMaster104 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $view = "
            ...
            SELECT 
                ...
                COALESCE(DATETIME(tdn.custom_delivery_time), DATETIME(attt_subq.xml_deliverytime_contents_formatted), DATETIME(vuf.created_at)) AS expected_delivery_date_coalesce,
