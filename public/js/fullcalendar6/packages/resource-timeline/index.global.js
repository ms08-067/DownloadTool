...
(c) 2022 Adam Shaw
*/
FullCalendar.ResourceTimeline = (function (exports, internal$1, core, premiumCommonPlugin, timelinePlugin, resourcePlugin, preact, internal$3, internal$2, internal$4) {
    'use strict';
    ...
    class SpreadsheetIndividualCell extends internal$1.BaseComponent {
        ...
        render() {
            ...
            return (preact.createElement(internal$1.ContentContainer, { elTag: "td", elClasses: [
                ...
                }, renderProps: renderProps, generatorName: "cellContent", generator: colSpec.cellContent || renderResourceInner, classNameGenerator: colSpec.cellClassNames, didMount: colSpec.cellDidMount, willUnmount: colSpec.cellWillUnmount }, (InnerContent) => (preact.createElement("div", { className: "fc-datagrid-cell-frame", style: { height: props.innerHeight } },
    ...
    class SpreadsheetGroupCell extends internal$1.BaseComponent {
        render() {
            ...
            return (preact.createElement(internal$1.ContentContainer, { elTag: "td", elClasses: [
                ...
                }, renderProps: renderProps, generatorName: "cellContent", generator: colSpec.cellContent || renderGroupInner, classNameGenerator: colSpec.cellClassNames, didMount: colSpec.cellDidMount, willUnmount: colSpec.cellWillUnmount }, (InnerContent) => (preact.createElement("div", { className: "fc-datagrid-cell-frame fc-datagrid-cell-frame-liquid" },
        ...
        render() {
            ...
            return (preact.createElement("tr", { role: "row" },
                preact.createElement(internal$1.ContentContainer, { elTag: "th", elClasses: [
                    ...
                    }, renderProps: renderProps, generatorName: "labelContent", generator: spec.labelContent || renderCellInner, classNameGenerator: spec.labelClassNames, didMount: spec.labelDidMount, willUnmount: spec.labelWillUnmount }, (InnerContent) => (preact.createElement("div", { className: "fc-datagrid-cell-frame", style: { height: props.innerHeight } },
    ...
    class SpreadsheetHeader extends internal$1.BaseComponent {
        ...
        render() {
            ...
            if (superHeaderRendering) {
                ...
                rowNodes.push(preact.createElement("tr", { key: "row-super", role: "row" },
                    preact.createElement(internal$1.ContentContainer, { elTag: "th", elClasses: [
                        ...
                        }, renderProps: renderProps, generatorName: "headerContent", generator: superHeaderRendering.headerContent, classNameGenerator: superHeaderRendering.headerClassNames, didMount: superHeaderRendering.headerDidMount, willUnmount: superHeaderRendering.headerWillUnmount }, (InnerContent) => (preact.createElement("div", { className: "fc-datagrid-cell-frame", style: { height: rowInnerHeight } },
            ...
            rowNodes.push(preact.createElement("tr", { key: "row", role: "row" }, colSpecs.map((colSpec, i) => {
                ...
                return (preact.createElement(internal$1.ContentContainer, { key: i, elTag: "th", elClasses: ['fc-datagrid-cell'], elAttrs: { role: 'columnheader' }, renderProps: renderProps, generatorName: "headerContent", generator: colSpec.headerContent, classNameGenerator: colSpec.headerClassNames, didMount: colSpec.headerDidMount, willUnmount: colSpec.headerWillUnmount }, (InnerContent) => (preact.createElement("div", { className: "fc-datagrid-cell-frame", style: { height: rowInnerHeight } },
                    preact.createElement("div", { className: "fc-datagrid-cell-cushion fc-scrollgrid-sync-inner" },
    ...
    */
        ...
        render() {
            ...
            return (preact.createElement("tr", { ref: props.elRef },
                preact.createElement(internal$1.ContentContainer, { elTag: "td", elRef: props.elRef, elClasses: [
                        ...
                        'fc-resource-group',
                        context.theme.getClass('tableCellShaded'),
                    ], renderProps: renderProps, generatorName: "laneContent", generator: renderHooks.laneContent, classNameGenerator: renderHooks.laneClassNames, didMount: renderHooks.laneDidMount, willUnmount: renderHooks.laneWillUnmount }, (InnerContainer) => (preact.createElement(InnerContainer, { elTag: "div", elStyle: { height: props.innerHeight } })))));
        }
    }
    ...
    class ResourceTimelineViewLayout extends internal$1.BaseComponent {
        ...
        render() {
            ...
            return (preact.createElement(internal$4.ScrollGrid, { ref: this.scrollGridRef, elRef: this.rootElRef, liquid: !props.isHeightAuto && !props.forPrint, collapsibleWidth: false, colGroups: [
...
})({}, FullCalendar.Internal, FullCalendar, FullCalendar.PremiumCommon, FullCalendar.Timeline, FullCalendar.Resource, FullCalendar.Preact, FullCalendar.Timeline.Internal, FullCalendar.Resource.Internal, FullCalendar.ScrollGrid.Internal);
