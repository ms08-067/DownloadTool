...
/**
 * Class AjaxManagedownloadlistTabsController
 *
 * @author sigmoswitch
 * @package App\Http\Controller
 */
class AjaxManagedownloadlistTabsController extends Controller
{
    /**
    ...
    /**
     * Send downloadlistInfo Tab HTML via Ajax
     *
     * @author sigmoswitch
     * @return \Illuminate\View\View
     */
    public function ajaxdownloadlistInfo_HTML()
    {
        $route = url()->current();
        ...
        return $this->render('manage_downloadlist._downloadlist');
    }

    /**
     * Get downloadlistInfo Table via Ajax
     *
     * @author sigmoswitch
     * @return \Illuminate\View\View
     */
    public function getdownloadlistInfo_TABLE(Request $request)
    {
        ...
        $downloadlist_list_file_count_array = DB::table('tasks_downloads_files')->get()->keyBy('id')->toArray();
        ...
        // })
        ->when($request->byToolClient_value, function($query) use ($request){
            /**dd($request->byToolClient_value);*/
            return $query->whereIn('xml_tool_client', $request->byToolClient_value);
        })
        ...
        $downloadlist_list_view_total = DB::table('v_download_files')
        // ->when($request->min_birthday, function($query) use ($request){
        //  return $query->whereBetween('birthday', [$request->min_birthday, $request->max_birthday]);
        // })
        // ->where(function($query) use ($today){
        ...
        if((int)$request->draw >= 0){
            ...
            //$controller_variables = app('App\Http\Controllers\ManagedownloadlistController')->index(true, 'accounting');
        ...
        ->setTransformer(new \App\Transformers\downloadlistListinfoTransformer(['locale' => $locale, 'status_grouping_sort_order' => $status_grouping_sort_order, 'search_query_type_highlighting' => $global_filter]))
    ...
    /**
     * Get Manage downloadlist Add downloadlist ColorBox
     *
     * @author sigmoswitch
     * @return \Illuminate\View\View
     */
    public function getManagedownloadlist_TabAccounting_add_downloadlist_CB()
    {
        ...
        return $this->render('manage_downloadlist.details.add_downloadlist');
    }

    /**
     * Get Manage downloadlist Edit downloadlist ColorBox
     *
     * @author sigmoswitch
     * @return \Illuminate\View\View
     */
    public function getManagedownloadlist_TabAccounting_edit_downloadlist_CB($id)
    {
        try {
            $IdENCRYPTED = $id;
        ...
        return $this->render('manage_downloadlist.details.edit_downloadlist');
        /***/
    }
