/*!
FullCalendar Premium Bundle v6.0.0-beta.2
    ...
    class SpreadsheetIndividualCell extends BaseComponent {
        ...
        render() {
            ...
            return (h(ContentContainer, { elTag: "td", elClasses: [
                ...
                }, renderProps: renderProps, generatorName: "cellContent", generator: colSpec.cellContent || renderResourceInner, classNameGenerator: colSpec.cellClassNames, didMount: colSpec.cellDidMount, willUnmount: colSpec.cellWillUnmount }, (InnerContent) => (h("div", { className: "fc-datagrid-cell-frame", style: { height: props.innerHeight } },
    ...
    class SpreadsheetGroupCell extends BaseComponent {
        render() {
            ...
            return (h(ContentContainer, { elTag: "td", elClasses: [
                ...
                }, renderProps: renderProps, generatorName: "cellContent", generator: colSpec.cellContent || renderGroupInner, classNameGenerator: colSpec.cellClassNames, didMount: colSpec.cellDidMount, willUnmount: colSpec.cellWillUnmount }, (InnerContent) => (h("div", { className: "fc-datagrid-cell-frame fc-datagrid-cell-frame-liquid" },
        ...
        render() {
            ...
            return (h("tr", { role: "row" },
                h(ContentContainer, { elTag: "th", elClasses: [
                    ...
                    }, renderProps: renderProps, generatorName: "labelContent", generator: spec.labelContent || renderCellInner, classNameGenerator: spec.labelClassNames, didMount: spec.labelDidMount, willUnmount: spec.labelWillUnmount }, (InnerContent) => (h("div", { className: "fc-datagrid-cell-frame", style: { height: props.innerHeight } },
    ...
    class SpreadsheetHeader extends BaseComponent {
        ...
        render() {
            ...
            rowNodes.push(h("tr", { key: "row", role: "row" }, colSpecs.map((colSpec, i) => {
                ...
                return (h(ContentContainer, { key: i, elTag: "th", elClasses: ['fc-datagrid-cell'], elAttrs: { role: 'columnheader' }, renderProps: renderProps, generatorName: "headerContent", generator: colSpec.headerContent, classNameGenerator: colSpec.headerClassNames, didMount: colSpec.headerDidMount, willUnmount: colSpec.headerWillUnmount }, (InnerContent) => (h("div", { className: "fc-datagrid-cell-frame", style: { height: rowInnerHeight } },
                    h("div", { className: "fc-datagrid-cell-cushion fc-scrollgrid-sync-inner" },
        ...
        render() {
            ...
            return (h("tr", { ref: props.elRef },
                h(ContentContainer, { elTag: "td", elRef: props.elRef, elClasses: [
                        ...
                        'fc-resource-group',
                        context.theme.getClass('tableCellShaded'),
                    ], renderProps: renderProps, generatorName: "laneContent", generator: renderHooks.laneContent, classNameGenerator: renderHooks.laneClassNames, didMount: renderHooks.laneDidMount, willUnmount: renderHooks.laneWillUnmount }, (InnerContainer) => (h(InnerContainer, { elTag: "div", elStyle: { height: props.innerHeight } })))));
        }
    }
